...
let result = {
  ...
  "(1024) Секция Visiting +4": 4,
  "(1024) Секция Explore +4": 4,
  "(1024) Секция Video +4": 4,
  "(1024) Секция Gallery +4": 4,
  "(1024) Секция Tickets +4": 4,
  "(1024) Форма покупки билетов +4": 4,
  "(1024) Секция Contacts +4": 4,
  "(1024) Блок footer +4": 4,
  "(768) Блок header +4": 4,
  "(768) Секция Welcome +4": 4,
  "(768) Секция Visiting +4": 4,
  "(768) Секция Explore +4": 4,
  "(768) Секция Video +4": 4,
  "(768) Секция Gallery +4": 4,
  "(768) Секция Tickets +4": 4,
  "(768) Форма покупки билетов +4": 4,
  "(768) Секция Contacts +4": 4,
  "(768) Блок footer +4": 4,
  "(420) Блок header +4": 4,
  "(420) Секция Welcome +4": 4,
  "(420) Секция Visiting +4": 4,
  "(420) Секция Explore +4": 4,
  "(420) Секция Video +4": 4,
  "(420) Секция Gallery +4": 4,
  "(420) Секция Tickets +4": 4,
  "(420) Форма покупки билетов +4": 4,
  "(420) Секция Contacts +4": 4,
  "(420) Блок footer +4": 4,
  ...
  "При изменении ширины экрана плавно изменяются размеры: слайдера сравнения изображений в секции Explore +2": 2,
  "При изменении ширины экрана плавно изменяются размеры: кастомного видеоплеера в секции Video +2": 2,
  "При изменении ширины экрана плавно изменяются размеры: слайдера в секции Video +2": 2,
  "При изменении ширины экрана плавно изменяются размеры: YouTube-видео в плейлисте в секции Video, маленькие видео выровнены по краям большого +2": 2,
  "При изменении ширины экрана плавно изменяются размеры: галереи изображений и изображений в ней +2": 2,
  "При изменении ширины экрана плавно изменяются размеры: карты +2": 2,
  "На ширине экрана 1024рх и меньше реализовано адаптивное меню +12": 12,
  "при нажатии на бургер-иконку меню появляется, плавно выдвигаясь слева, бургер-иконка изменяется на крестик. При нажатии на крестик меню исчезает, плавно возвращаясь назад, иконка крестика превращается в бургер-иконку +2": 2,
  ...
  "вёрстка меню соответствует макету на всех проверяемых разрешениях +6": 3,
